...
, ('5', 'Grant', 'Grants the ability to grant other users perissions', 'Granted to role: SUPERVISOR', 1)
...
, ('8', 'Recrute', 'Grants the ability to recrute', 'Granted to role: RECRUTER', 0)
, ('9', 'Godly', 'Grants the ability to delete the entire workspace', 'Granted to role: GOD', 0)
, ('10', 'Visitor', 'Grants the ability to have acces to a workspace for a short time', 'Granted to role: TEMPORARY', 1);
...
, ('2', 'Admin', 'Gives the roles of creating, deleting, changing tables and can edit the roles of others', 2, 'Used for higher level personell ')
, ('3', 'Viewer', 'Only allows the user to view data in and the colums of tables', 3, 'Used for personell who should only be able to view data')
, ('4', 'Inserter', 'Only allows the user to insert data into tables', 4, 'Used for personell who should only be able to insert data')
, ('5', 'Deleter', 'Only allows the user to delete data in tables', 5, 'Used for personell who should only be able to delete data')
...
, ('9', 'God', 'Grants the God-like power to create and destroy the enteirey of a workspace', 10, 'Used for God-like users')
...
, ('5', 'Special Event', 'Used for the least important entires', NULL, 5)
